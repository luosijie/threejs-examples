import{q as u,aE as A,aF as L,aa as P,aC as _,S as y,T as F,s as v,f as R,M as U,d as D,w as B,W as G,i as T}from"./three.module.aa667966.js";import{O as z}from"./OrbitControls.179b081c.js";import{D as E,G as W}from"./DRACOLoader.2af43901.js";import{_ as j,g as O,c as q,o as V}from"./index.ca067ba1.js";const H=`uniform sampler2D tBackground;\r
\r
varying vec2 vUv;\r
\r
void main()\r
...
`;function K(){const t={tShadow:{value:null},uShadowColor:{value:null},uAlpha:{value:null}};return new _({wireframe:!1,transparent:!0,uniforms:t,vertexShader:J,fragmentShader:I})}const N={id:"canvas"},Q={__name:"index",setup(t){return O(()=>{const a=document.querySelector("#canvas"),n=new y,s=new F,d=s.load("resources/house-in-desert/textures/baked.jpg");d.flipY=!1,d.encoding=v;const o=s.load("resources/house-in-desert/textures/floor-shadow.jpg");o.flipY=!1,o.encoding=v;const h=new R(2,2,2,2),g=new $,l=new U(h,g);l.frustumCulled=!1,l.matrixAutoUpdate=!1,l.updateMatrix(),n.add(l);const p=new E;p.setDecoderPath("draco/");const f=new W;f.setDRACOLoader(p);const b=new D({map:d}),c=new K;c.depthWrite=!1,c.uniforms.uShadowColor.value=new u("#927044"),c.uniforms.tShadow.value=o,c.uniforms.uAlpha.value=.6,f.load("resources/house-in-desert/models/house.glb",w=>{const k=w.scene.children.find(m=>m.name==="baked");k.material=b;const C=w.scene.children.find(m=>m.name==="ground");C.material=c,n.add(w.scene)});const e={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{e.width=window.innerWidth,e.height=window.innerHeight,r.aspect=e.width/e.height,r.updateProjectionMatrix(),i.setSize(e.width,e.height),i.setPixelRatio(Math.min(window.devicePixelRatio,2))});const r=new B(45,e.width/e.height,.1,100);r.position.x=12,r.position.y=12,r.position.z=8,n.add(r);const M=new z(r,a);M.enableDamping=!0;const i=new G({canvas:a,antialias:!0});i.setSize(e.width,e.height),i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.outputEncoding=v;const S=new T,x=()=>{S.getElapsedTime(),M.update(),i.render(n,r),window.requestAnimationFrame(x)};x()}),(a,n)=>(V(),q("canvas",N))}},ae=j(Q,[["__scopeId","data-v-a2989d8e"]]);export{ae as default};
